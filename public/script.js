...
// Handle support navigation - scroll to support section or redirect to index
function scrollToSupport() {
    const supportSection = document.getElementById('support');
    if (supportSection) {
        // We're on a page with support section, scroll to it
        supportSection.scrollIntoView({ 
            behavior: 'smooth',
            block: 'start'
        });
    } else {
        // We're on a page without support section, redirect to index with support hash
...
function handleNavigation() {
    // Handle support links specifically
    const supportLinks = document.querySelectorAll('a[href*="#support"], a[href="./index.html#support"]');
